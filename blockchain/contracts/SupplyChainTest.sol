...
contract SupplyChain {
    ...
    mapping (address => address[]) external supplierRawMaterials;
    ...
    mapping (address => address[]) external manufacturerRawMaterials;
    mapping (address => address[]) external manufacturerMedicines;
